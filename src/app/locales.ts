...
export const LANGUAGE_OPTIONS: Array<{ value: Language; label: string; sub: LocalizedText }> = [
  { value: 'ko', label: '한국어', sub: { ko: '한국어', en: 'Korean', ar: 'الكورية', 'zh-TW': '韓文' } },
  { value: 'en', label: 'English', sub: { ko: '영어', en: 'English', ar: 'الإنجليزية', 'zh-TW': '英文' } },
  { value: 'ar', label: 'العربية', sub: { ko: '아랍어', en: 'Arabic', ar: 'العربية', 'zh-TW': '阿拉伯文' } },
  { value: 'zh-CN', label: '简体中文', sub: { ko: '중국어 간체', en: 'Chinese (Simplified)', ar: 'الصينية المبسطة', 'zh-TW': '簡體中文' } },
  { value: 'ja', label: '日本語', sub: { ko: '일본어', en: 'Japanese', ar: 'اليابانية', 'zh-TW': '日文' } },
  { value: 'zh-TW', label: '繁體中文', sub: { ko: '중국어 번체', en: 'Chinese (Traditional)', ar: 'الصينية التقليدية', 'zh-TW': '繁體中文' } },
  { value: 'es', label: 'Español', sub: { ko: '스페인어', en: 'Spanish', ar: 'الإسبانية', 'zh-TW': '西班牙文' } },
];
...
type ProvisionalTranslation = Partial<Record<NewLanguage, string>>;
...
const PROVISIONAL_TRANSLATIONS: Record<string, ProvisionalTranslation> = {
  ...
  // zh-TW demo-flow completion. These entries intentionally use Taiwan UI wording
  // instead of borrowing the zh-CN copy or falling back to English.
  '나에게 맞는 한 끼,\n새로운 한국의 발견.': { 'zh-TW': '適合我的一餐，\n探索不一樣的韓國。' },
  '동네를 고르고, 내 식단을 이해하는 식당을 만나보세요.': { 'zh-TW': '選一個街區，尋找了解你飲食需求的餐廳。' },
  '추천 이야기': { 'zh-TW': '精選故事' },
  '이야기': { 'zh-TW': '故事' },
  '이미 식당에 도착했나요?': { 'zh-TW': '已經到餐廳了嗎？' },
  '메뉴판 한 장으로 내 식단 확인하기': { 'zh-TW': '拍一張菜單，確認是否符合我的飲食需求' },
  '오늘은 어느 동네를 살펴볼까요?': { 'zh-TW': '今天想逛哪個街區？' },
  '전체 지도': { 'zh-TW': '查看完整地圖' },
  '지도를 불러오지 못했어요. 아래 목록에서 찾아주세요.': { 'zh-TW': '無法載入地圖，請從下方清單中選擇。' },
  '어떤 언어를 사용하시나요?': { 'zh-TW': '想使用哪一種語言？' },
  '어느 나라에서 오셨나요?': { 'zh-TW': '你來自哪個國家或地區？' },
  '식단 프로필을 알려주세요': { 'zh-TW': '告訴我們你的飲食需求' },
  '앱에서 사용할 언어를 선택해주세요.': { 'zh-TW': '請選擇要在 App 中使用的語言。' },
  '지역에 맞는 언어와 화폐 안내에 활용해요.': { 'zh-TW': '我們會依此提供適合所在地的語言與幣別資訊。' },
  '필요한 항목만 골라도 충분해요.': { 'zh-TW': '只要選擇與你相關的項目就可以了。' },
  'YOUR TASTE, YOUR KOREA': { 'zh-TW': '你的口味，你的韓國旅程' },
  'WELCOME TO HAN SPOON': { 'zh-TW': '歡迎使用 HAN SPOON' },
  'NEIGHBORHOOD SPOTLIGHT': { 'zh-TW': '街區焦點' },
  'HAN SPOON JOURNAL': { 'zh-TW': 'HAN SPOON 專題' },
  'EXPLORE THE MAP': { 'zh-TW': '探索地圖' },
  'HAN SPOON PICKS': { 'zh-TW': 'HAN SPOON 精選' },
  '에디터의 선택': { 'zh-TW': '編輯精選' },
  'HAN SPOON 에디토리얼': { 'zh-TW': 'HAN SPOON 編輯專欄' },
  '계속 둘러보기': { 'zh-TW': '繼續探索' },
  'YOUR MENU, MADE CLEAR': { 'zh-TW': '清楚看懂你的菜單' },
  'A LITTLE MORE KOREA': { 'zh-TW': '再認識一點韓國' },
  '메뉴판 글자를 읽지 못했습니다. 사진을 다시 선택해 주세요.': { 'zh-TW': '無法辨識菜單文字，請重新選擇照片。' },
  '분석 시간이 초과되었습니다. 잠시 후 새 사진으로 시도해 주세요.': { 'zh-TW': '分析逾時，請稍後改用一張新照片再試一次。' },
  '분석 서버가 일시적으로 혼잡합니다. 잠시 후 다시 시도해 주세요.': { 'zh-TW': '分析服務目前繁忙，請稍後再試。' },
  '메뉴 분석 결과를 완성하지 못했습니다. 새 사진으로 다시 시도해 주세요.': { 'zh-TW': '無法完成菜單分析，請改用一張新照片再試一次。' },
  '스캔에 실패했습니다. 새 사진으로 다시 시도해 주세요.': { 'zh-TW': '掃描失敗，請改用一張新照片再試一次。' },
  '분석할 이미지를 찾을 수 없습니다. 새 사진을 선택해 주세요.': { 'zh-TW': '找不到要分析的圖片，請選擇一張新照片。' },
  '새 사진으로 다시 시도': { 'zh-TW': '換張照片再試一次' },
  '내 프로필로 보는 메뉴': { 'zh-TW': '依我的飲食檔案查看餐點' },
  '등록 레시피로 바로 확인': { 'zh-TW': '直接查看已登錄的食譜' },
  '메뉴를 골랐다면, 한식 이야기': { 'zh-TW': '選好餐點後，再讀一篇韓食故事' },
  '프로필 수정하기': { 'zh-TW': '編輯飲食檔案' },
  '식당 선택 · 나중에 해도 괜찮아요': { 'zh-TW': '選擇餐廳 · 之後再選也可以' },
  '등록된 메뉴가 없는 식당이에요.': { 'zh-TW': '這家餐廳目前沒有已登錄的菜單。' },
  '지도로 돌아가기': { 'zh-TW': '返回地圖' },
  '주의 판정 요약': { 'zh-TW': '注意事項摘要' },
  '확인하고 선택해요': { 'zh-TW': '確認後再選擇' },
  '재료 확인 필요': { 'zh-TW': '需要確認食材' },
  '수치로 확인된 정보가 없어 확률은 표시하지 않아요.': { 'zh-TW': '目前沒有可量化的資訊，因此不顯示機率。' },
  '재료 포함 추정치이며 직원 확인이 필요해요.': { 'zh-TW': '這是食材可能含有的估計值，仍需向店員確認。' },
  '섭취 안전 확률이 아니에요.': { 'zh-TW': '這不是食用安全機率。' },
  '재료별 근거': { 'zh-TW': '各食材的判斷依據' },
  '근거': { 'zh-TW': '判斷依據' },
  '출처가 달라 직원 확인이 필요해요.': { 'zh-TW': '資料來源不一致，請向店員確認。' },
  '아직 확인 기록이 충분하지 않아요.': { 'zh-TW': '目前的確認紀錄還不夠充分。' },
  '주의 재료가 숨어 있는 곳': { 'zh-TW': '需留意食材可能藏在哪裡' },
  '주문 전, 이것만 확인해요': { 'zh-TW': '點餐前，請先確認這些事項' },
  '상세 근거가 아직 제공되지 않았어요.': { 'zh-TW': '目前尚未提供詳細判斷依據。' },
  '참고 사진': { 'zh-TW': '示意照片' },
  '화면에 맞춰 크롭': { 'zh-TW': '裁切以符合畫面' },
  '오늘의 메뉴 기록하기': { 'zh-TW': '記下今天的餐點' },
  '스캔 기록에서 언제든 다시 볼 수 있어요.': { 'zh-TW': '之後可以隨時在掃描紀錄中查看。' },
  '식당을 연결하거나, 메뉴만 간단히 저장하세요.': { 'zh-TW': '可以連結餐廳，也可以只儲存餐點。' },
  '연결하지 않아도 기록이 저장돼요': { 'zh-TW': '不連結餐廳也能儲存紀錄' },
  '내 식단을 전달하기 편했나요?': { 'zh-TW': '向店員說明飲食需求時順利嗎？' },
  '직접 경험한 항목만 알려주세요. 나중에 남겨도 괜찮아요.': { 'zh-TW': '只需回覆你親自體驗過的項目，也可以稍後再填。' },
  '나의 메뉴 스캔': { 'zh-TW': '我的菜單掃描' },
  '내 식단': { 'zh-TW': '我的飲食需求' },
  '직원 응답을 기록했어요. 분석 판정은 자동으로 바뀌지 않으며 교차접촉도 별도로 확인해 주세요.': { 'zh-TW': '已記錄店員回覆。分析結果不會自動變更，交叉接觸也請另外確認。' },
  '한 입 더, 한국': { 'zh-TW': '再嚐一口韓國' },
  '식탁의 이야기부터 여행의 작은 요령까지.': { 'zh-TW': '從餐桌故事到旅行中的實用小技巧。' },
  '큐레이션 검색': { 'zh-TW': '搜尋精選文章' },
  '어떤 이야기가 궁금하세요?': { 'zh-TW': '想讀哪一個故事？' },
  '찾은 이야기': { 'zh-TW': '搜尋結果' },
  '편': { 'zh-TW': '篇' },
  '잠깐의 읽을거리': { 'zh-TW': '短篇閱讀' },
  '전체 보기': { 'zh-TW': '查看全部' },
  '한 끼가 여행이 되는 곳': { 'zh-TW': '讓一頓飯成為一段旅程' },
  '다음 한 끼를 위한 식당 발견': { 'zh-TW': '探索下一餐的好去處' },
  '식당 목록을 불러오지 못했어요.': { 'zh-TW': '無法載入餐廳清單。' },
  '아직 이 동네의 식당을 준비 중이에요.': { 'zh-TW': '這個街區的餐廳資料仍在準備中。' },
  '위에서 다른 동네도 살펴보세요.': { 'zh-TW': '也可以從上方選擇其他街區。' },
  '다시 불러오기': { 'zh-TW': '重新載入' },
  '식당 추천': { 'zh-TW': '餐廳推薦' },
  '캐러셀': { 'zh-TW': '輪播內容' },
  '사진은 메뉴·공간 참고 이미지입니다.': { 'zh-TW': '照片為餐點與空間的示意圖片。' },
  '선택한 동네의 식당을 소개해요. 사진은 메뉴·공간 참고 이미지입니다.': { 'zh-TW': '為你介紹所選街區的餐廳。照片為餐點與空間的示意圖片。' },
  '이전 식당': { 'zh-TW': '上一家餐廳' },
  '다음 식당': { 'zh-TW': '下一家餐廳' },
  '지도에서 보기': { 'zh-TW': '在地圖上查看' },
  '동네에서 만나는 한 끼': { 'zh-TW': '在街區裡遇見下一餐' },
  '지도에서 만나보기': { 'zh-TW': '到地圖上看看' },
  '입점 및 전체 레시피 인증': { 'zh-TW': '合作餐廳 · 全食譜資料已確認' },
  '서비스 등록 확인': { 'zh-TW': '服務登錄狀態' },
  '등록된 식당': { 'zh-TW': '已登錄餐廳' },
  '이 지역에 등록된 식당이 없어요.': { 'zh-TW': '這個地區目前沒有已登錄的餐廳。' },
  '식당을 연결하면 오늘의 메뉴를 방문 기록으로 모을 수 있어요.': { 'zh-TW': '連結餐廳後，就能把今天的餐點收進造訪紀錄。' },
  '식당 이름 · 영문 이름 · 지역': { 'zh-TW': '餐廳名稱 · 英文名稱 · 地區' },
  '목록만 보기': { 'zh-TW': '只看清單' },
  '지도로 보기': { 'zh-TW': '查看地圖' },
  '검색 결과가 없어요. 지역을 선택해 찾아보세요.': { 'zh-TW': '找不到符合的結果，請選擇地區再搜尋。' },
  '홈으로': { 'zh-TW': '回到首頁' },
  '식당 또는 지역 검색': { 'zh-TW': '搜尋餐廳或地區' },
  '검색 지우기': { 'zh-TW': '清除搜尋' },
  '검색 결과가 없어요.': { 'zh-TW': '找不到符合的結果。' },
  '지역 선택': { 'zh-TW': '選擇地區' },
  '위치를 확인하지 못해 성수 식당을 보여드려요. 지역을 선택할 수 있어요.': { 'zh-TW': '無法取得位置，先為你顯示聖水的餐廳。你也可以選擇其他地區。' },
  '이 지역의 식당': { 'zh-TW': '這個地區的餐廳' },
  '1인 예상': { 'zh-TW': '每人預估' },
  '식단 경험': { 'zh-TW': '飲食需求經驗' },
  '위의 지역 버튼으로 다른 동네를 둘러보세요.': { 'zh-TW': '使用上方的地區按鈕探索其他街區。' },
  '한스푼 파트너가 모든 레시피를 제공했어요.': { 'zh-TW': 'Han Spoon 合作餐廳已提供所有食譜資料。' },
  '레시피 인증은 정보 확인 범위를 뜻하며, 개인별 섭취 안전을 보장하지 않아요.': { 'zh-TW': '食譜資料確認代表資訊的確認範圍，不保證每個人都能安全食用。' },
  '내 프로필로 메뉴 보기': { 'zh-TW': '依我的飲食檔案查看菜單' },
  '식당 찜하기': { 'zh-TW': '收藏餐廳' },
  '선택한 조건이 하나 이상 같은 방문자의 선택형 후기예요.': { 'zh-TW': '這些是至少有一項飲食條件與你相同的訪客所留下的選項式回饋。' },
  '아직 같은 프로필의 후기가 없어요.': { 'zh-TW': '目前還沒有相似飲食檔案的回饋。' },
  '식단 프로필을 설정하면 나와 비슷한 사람들의 경험을 볼 수 있어요.': { 'zh-TW': '設定飲食檔案後，就能查看與你需求相近的訪客經驗。' },
  '내 위치': { 'zh-TW': '我的位置' },
  '지도 중심 주변': { 'zh-TW': '地圖中心附近' },
  '여행의 맛을 모아두세요. 식당을 연결한 기록과 메뉴 스캔을 모두 볼 수 있어요.': { 'zh-TW': '收藏旅途中的味道。這裡會顯示已連結餐廳的紀錄與所有菜單掃描。' },
  '첫 번째 메뉴를 기록해 보세요.': { 'zh-TW': '記下你的第一份菜單吧。' },
  '메뉴 스캔하기': { 'zh-TW': '掃描菜單' },
  '홈': { 'zh-TW': '首頁' },
  '지도': { 'zh-TW': '地圖' },
  '지도 언어': { 'zh-TW': '地圖語言' },
  '지도에 표시되는 지명 언어예요. 기본은 한국어예요.': { 'zh-TW': '這是地圖上地名的顯示語言，預設為韓文。' },
  '사진을 불러오지 못했어요': { 'zh-TW': '無法載入照片' },
  '사진은 글의 이해를 돕는 참고 이미지입니다.': { 'zh-TW': '照片為協助理解文章的示意圖片。' },
  '다음 한 입의 이야기': { 'zh-TW': '下一篇美食故事' },

  // Demo areas and restaurant menu data.
  '내 주변': { 'zh-TW': '我的附近' },
  '청담': { 'zh-TW': '清潭' },
  '강남·역삼': { 'zh-TW': '江南 · 驛三' },
  '광화문·종로': { 'zh-TW': '光化門 · 鐘路' },
  ...
  '명동·을지로': { 'zh-TW': '明洞 · 乙支路' },
  '홍대·신촌': { 'zh-TW': '弘大 · 新村' },
  '버섯 채소 솥밥': { 'zh-TW': '菇菇蔬菜釜飯' },
  '두부 간장구이': { 'zh-TW': '醬油烤豆腐' },
  '달걀 비빔밥': { 'zh-TW': '雞蛋拌飯' },
  '버섯 크림밥': { 'zh-TW': '奶油蘑菇飯' },
  '돼지고기 김치찌개': { 'zh-TW': '豬肉泡菜鍋' },
  '고등어 소금구이': { 'zh-TW': '鹽烤鯖魚' },
  '쌀': { 'zh-TW': '米' },
  '버섯': { 'zh-TW': '蘑菇' },
  '채소': { 'zh-TW': '蔬菜' },
  '달걀': { 'zh-TW': '雞蛋' },
  '고추': { 'zh-TW': '辣椒' },
  '프로필을 설정하면 등록된 레시피와 내 기준을 비교할 수 있어요.': { 'zh-TW': '設定飲食檔案後，就能將已登錄的食譜與你的需求進行比對。' },
  '표시 재료 외에도 종교 기준에 따른 인증과 조리 과정을 확인해 주세요.': { 'zh-TW': '除了列出的食材，也請確認符合宗教飲食規範所需的認證與烹調流程。' },
  '등록된 레시피에서 내 프로필과 충돌하는 재료를 찾지 못했어요. 공용 조리도구는 직원에게 확인해 주세요.': { 'zh-TW': '在已登錄的食譜中未發現與你飲食檔案衝突的食材。共用廚具仍請向店員確認。' },
  '식당 등록 레시피': { 'zh-TW': '餐廳提供的食譜' },

  // Fixed scan scenario: menu names, descriptions, decision reasons and staff questions.
  '야채김밥': { 'zh-TW': '蔬菜紫菜飯捲' },
  '참치김밥': { 'zh-TW': '鮪魚紫菜飯捲' },
  '스팸김밥': { 'zh-TW': '午餐肉紫菜飯捲' },
  '매운 떡볶이': { 'zh-TW': '辣炒年糕' },
  ...
  '식혜': { 'zh-TW': '韓式甜米釀' },
  '수정과': { 'zh-TW': '韓式桂皮生薑甜茶' },
  '밥과 아삭한 채소를 김으로 말아 한입 크기로 썬 김밥이에요.': { 'zh-TW': '將白飯與爽脆蔬菜包進海苔，再切成一口大小的紫菜飯捲。' },
  '이름은 야채김밥이지만 달걀 지단이나 어묵이 함께 들어갈 수 있어요. 비건 김밥인지 확인해 주세요.': { 'zh-TW': '雖然叫蔬菜紫菜飯捲，仍可能加入蛋皮或魚板。請確認是否為全素。' },
  '기본 김밥의 지단·어묵은 매장마다 달라요.': { 'zh-TW': '每家店的基本飯捲是否加入蛋皮與魚板都不同。' },
  '달걀·어묵·햄 없이, 채소만 넣어 새로 말아주실 수 있나요?': { 'zh-TW': '可以不加雞蛋、魚板和火腿，只用蔬菜重新做一捲嗎？' },
  '새우를 다룬 칼·도마·김밥 발을 함께 쓰는지 확인해요.': { 'zh-TW': '請確認刀具、砧板與壽司竹簾是否也曾接觸蝦子。' },
  '달걀 지단': { 'zh-TW': '蛋皮' },
  '어묵': { 'zh-TW': '魚板' },
  '김밥 속재료': { 'zh-TW': '飯捲內餡' },
  '달걀 지단·어묵 가능': { 'zh-TW': '可能含蛋皮或魚板' },
  '비건 기준 확인': { 'zh-TW': '確認是否符合全素需求' },
  '참치를 중심으로 밥과 채소를 김에 말아낸 고소한 김밥이에요.': { 'zh-TW': '以鮪魚為主，搭配白飯與蔬菜包入海苔的香濃紫菜飯捲。' },
  '주재료가 생선인 참치여서 비건 기준에 맞지 않아요. 마요네즈에도 달걀이 들어갈 수 있어요.': { 'zh-TW': '主食材鮪魚屬於魚類，不符合全素需求；美乃滋也可能含有雞蛋。' },
  '참치 속에 마요네즈를 섞는 조리법이 흔해요.': { 'zh-TW': '常見做法會將鮪魚與美乃滋拌在一起。' },
  '참치가 들어간 김밥 대신 동물성 재료 없는 야채김밥을 새로 만들 수 있나요?': { 'zh-TW': '可以不要鮪魚飯捲，改做一份不含動物性食材的蔬菜飯捲嗎？' },
  '참치는 새우와 다른 재료예요. 새우 교차접촉 여부는 별도로 확인해요.': { 'zh-TW': '鮪魚和蝦子是不同食材，仍需另外確認是否有蝦類交叉接觸。' },
  '참치': { 'zh-TW': '鮪魚' },
  '구운 스팸의 짭조름한 맛에 밥과 채소가 어우러진 김밥이에요.': { 'zh-TW': '鹹香煎午餐肉搭配白飯與蔬菜的紫菜飯捲。' },
  '스팸은 육류 가공품이므로 비건 기준에 맞지 않아요. 스팸을 뺀 새 김밥을 주문해야 해요.': { 'zh-TW': '午餐肉是肉類加工品，不符合全素需求；需要另外點一份不加午餐肉的新飯捲。' },
  '스팸을 구워 김밥 속에 넣어요.': { 'zh-TW': '將午餐肉煎過後包進飯捲。' },
  '스팸·달걀·어묵 없이 채소만 넣은 김밥으로 바꿀 수 있나요?': { 'zh-TW': '可以改成不加午餐肉、雞蛋與魚板，只放蔬菜的飯捲嗎？' },
  '고기를 굽는 팬과 새우 조리도구의 공유 여부를 확인해요.': { 'zh-TW': '請確認煎肉的平底鍋是否與蝦類料理共用器具。' },
  '스팸(육류)': { 'zh-TW': '午餐肉（肉類）' },
  '쫄깃한 떡을 매콤달콤한 고추장 양념에 졸인 분식이에요.': { 'zh-TW': 'Q 彈年糕以甜辣辣椒醬燉煮而成的韓式街頭小吃。' },
  '떡 자체보다 어묵과 멸치 육수가 비건 기준에 걸릴 수 있어요. 새우 분말이 든 복합 양념도 확인해 주세요.': { 'zh-TW': '年糕本身之外，魚板與鯷魚高湯可能不符合全素需求，也請確認綜合調味料是否含蝦粉。' },
  '어묵과 멸치 육수를 함께 넣는 조리법이 있어요.': { 'zh-TW': '部分做法會加入魚板與鯷魚高湯。' },
  '채소 육수를 쓰나요? 어묵과 새우 분말 없이 따로 조리할 수 있나요?': { 'zh-TW': '使用的是蔬菜高湯嗎？可以不加魚板和蝦粉，另外烹煮嗎？' },
  '새우튀김을 떡볶이 소스에 담그거나 집게를 공유하는지 확인해요.': { 'zh-TW': '請確認炸蝦是否會沾入辣炒年糕醬汁，或與其他餐點共用夾子。' },
  '멸치 육수': { 'zh-TW': '鯷魚高湯' },
  '새우 분말': { 'zh-TW': '蝦粉' },
  '떡볶이 양념·육수': { 'zh-TW': '辣炒年糕醬汁與高湯' },
  '어묵·멸치·새우 분말 가능': { 'zh-TW': '可能含魚板、鯷魚或蝦粉' },
  '비건·새우 기준 확인': { 'zh-TW': '確認全素與蝦類過敏需求' },
  '탄력 있는 면과 채소를 새콤매콤한 양념에 비벼 먹는 음식이에요.': { 'zh-TW': '將有嚼勁的麵條與蔬菜拌入酸辣醬汁的料理。' },
  '삶은 달걀 고명이 올라갈 수 있고 양념에 액젓이 쓰일 수 있어요. 둘 다 비건 기준 확인이 필요해요.': { 'zh-TW': '可能會放水煮蛋配料，醬汁也可能使用魚露；兩者都需要確認是否符合全素需求。' },
  '면·채소 외에 달걀 고명과 양념 배합이 달라져요.': { 'zh-TW': '除了麵與蔬菜，各店使用的雞蛋配料與醬汁配方不同。' },
  '달걀 고명 없이 가능할까요? 양념에 액젓이나 새우 성분이 들어가나요?': { 'zh-TW': '可以不加雞蛋配料嗎？醬汁裡有魚露或蝦類成分嗎？' },
  '양념 용기와 집게가 해산물 메뉴와 공유되는지 확인해요.': { 'zh-TW': '請確認醬料容器與夾子是否和海鮮餐點共用。' },
  '달걀 고명': { 'zh-TW': '雞蛋配料' },
  '액젓': { 'zh-TW': '魚露' },
  '쫄면 고명·양념': { 'zh-TW': '辣拌麵配料與醬汁' },
  '달걀·액젓 가능': { 'zh-TW': '可能含雞蛋或魚露' },
  '꼬불꼬불한 면을 얼큰한 국물에 끓여낸 따뜻한 면 요리예요.': { 'zh-TW': '將捲曲麵條煮在香辣湯頭裡的熱湯麵。' },
  '사용하는 라면 제품을 알 수 없어요. 스프의 육류 추출물과 새우 성분을 성분표로 확인해야 해요.': { 'zh-TW': '目前不知道使用哪一款泡麵，需查看包裝成分表，確認調味粉是否含肉類萃取物或蝦類成分。' },
  '면보다 스프 제품과 추가 달걀이 핵심 확인 대상이에요.': { 'zh-TW': '比起麵體，更需要確認調味粉與是否另外加蛋。' },
  '라면 포장지의 성분표를 볼 수 있나요? 육류·새우·달걀 없이 가능한가요?': { 'zh-TW': '可以看一下泡麵包裝上的成分表嗎？能做成不含肉類、蝦類與雞蛋的版本嗎？' },
  '냄비·국자를 해물라면과 같이 쓰는지 확인해요.': { 'zh-TW': '請確認鍋具與湯勺是否和海鮮泡麵共用。' },
  '육류 추출물': { 'zh-TW': '肉類萃取物' },
  '새우 성분': { 'zh-TW': '蝦類成分' },
  '라면 스프': { 'zh-TW': '泡麵調味粉' },
  '육류 추출물·새우 성분 가능': { 'zh-TW': '可能含肉類萃取物或蝦類成分' },
  '제품 성분표 확인': { 'zh-TW': '查看產品成分標示' },
  '생선살로 만든 어묵을 따뜻한 국물에 끓여낸 탕이에요.': { 'zh-TW': '將魚漿製成的魚板放入熱湯中燉煮。' },
  '어묵은 생선살로 만드는 음식이라 비건 기준에 맞지 않아요. 어묵 제품의 새우 성분은 별도 확인이 필요해요.': { 'zh-TW': '魚板以魚肉製成，不符合全素需求；該魚板產品是否含蝦類成分則需另外確認。' },
  '어묵을 빼도 생선 성분이 국물에 남을 수 있어요.': { 'zh-TW': '即使取出魚板，湯裡仍可能留有魚類成分。' },
  '생선·새우 성분이 없는 별도의 채소 국물이 있나요?': { 'zh-TW': '有另外準備、不含魚類與蝦類成分的蔬菜湯嗎？' },
  '어묵 제품의 성분표와 공용 국자를 확인해요.': { 'zh-TW': '請確認魚板產品的成分標示，以及是否共用湯勺。' },
  '생선살(어묵)': { 'zh-TW': '魚肉（魚板）' },
  '당면 등을 속에 채워 쪄낸 한국식 순대를 먹기 좋게 썬 메뉴예요.': { 'zh-TW': '將冬粉等內餡填入腸衣蒸熟，再切成方便入口大小的韓式血腸。' },
  '일반적인 순대는 돼지 창자와 선지를 사용해 비건 기준에 맞지 않아요. 새우젓 곁들임도 피해야 해요.': { 'zh-TW': '一般韓式血腸會使用豬腸與豬血，不符合全素需求；搭配的蝦醬也需要避開。' },
  '속의 당면만 보고 식물성 음식으로 판단할 수 없어요.': { 'zh-TW': '不能只看到內餡的冬粉，就判斷這是植物性料理。' },
  '순대 대신 동물성 재료 없는 메뉴가 있나요? 새우젓은 함께 내지 말아주세요.': { 'zh-TW': '有不含動物性食材、可以替代韓式血腸的餐點嗎？也請不要附蝦醬。' },
  '새우젓을 담는 종지·집게의 공유 여부를 확인해요.': { 'zh-TW': '請確認盛裝蝦醬的小碟與夾子是否共用。' },
  '돼지 창자·선지': { 'zh-TW': '豬腸與豬血' },
  '새우에 튀김옷을 입혀 바삭하게 튀긴 메뉴예요.': { 'zh-TW': '蝦子裹上麵衣後炸至酥脆的餐點。' },
  '새우가 주재료여서 새우 알레르기와 직접 충돌하고 비건 기준에도 맞지 않아요.': { 'zh-TW': '蝦子是主要食材，直接不符合你的蝦類過敏需求，也不符合全素飲食。' },
  '튀김옷을 벗겨도 새우 알레르기 위험이 사라지지 않아요.': { 'zh-TW': '即使去掉麵衣，蝦類過敏原也不會消失。' },
  '새우 알레르기가 있어요. 새우와 접촉하지 않게 따로 조리한 다른 메뉴가 있나요?': { 'zh-TW': '我對蝦子過敏。請問有不接觸蝦子、另外烹調的其他餐點嗎？' },
  '다른 튀김도 새우와 같은 기름·튀김망을 쓸 수 있어요.': { 'zh-TW': '其他炸物也可能和炸蝦共用炸油與炸籃。' },
  '오징어에 튀김옷을 입혀 겉은 바삭하고 속은 쫄깃하게 튀겼어요.': { 'zh-TW': '魷魚裹上麵衣，炸成外酥內彈的口感。' },
  '오징어는 동물성 재료여서 비건 기준에 맞지 않아요. 새우와는 다른 재료지만 조리 기름 공유는 확인해야 해요.': { 'zh-TW': '魷魚是動物性食材，不符合全素需求。雖然不是蝦子，仍需確認是否共用炸油。' },
  '오징어를 길게 썰어 반죽을 입혀 튀겨요.': { 'zh-TW': '將魷魚切成長條，裹上麵糊後油炸。' },
  '새우튀김과 같은 기름·튀김망을 쓰나요? 별도 조리한 식물성 메뉴가 있나요?': { 'zh-TW': '會和炸蝦共用炸油與炸籃嗎？有另外烹調的植物性餐點嗎？' },
  '메뉴판에 새우튀김도 있어 기름 공유 여부는 미확인이에요.': { 'zh-TW': '菜單上也有炸蝦，目前尚未確認是否共用炸油。' },
  '여러 채소에 가벼운 튀김옷을 입혀 바삭하게 튀겨낸 메뉴예요.': { 'zh-TW': '多種蔬菜裹上薄麵衣，炸成酥脆口感。' },
  '채소 튀김이라도 반죽에 달걀이 들어갈 수 있어요. 새우튀김과 같은 기름을 쓰는지도 꼭 확인해 주세요.': { 'zh-TW': '即使是蔬菜炸物，麵糊仍可能含雞蛋；也請務必確認是否和炸蝦共用炸油。' },
  '채소는 식물성이지만 반죽의 배합은 알 수 없어요.': { 'zh-TW': '蔬菜是植物性食材，但目前不知道麵糊配方。' },
  '반죽에 달걀·우유가 있나요? 새우와 다른 기름과 도구로 튀길 수 있나요?': { 'zh-TW': '麵糊裡有雞蛋或牛奶嗎？可以使用與蝦子分開的炸油和器具嗎？' },
  '공용 튀김기 여부는 미확인 · 교차접촉 확률은 계산하지 않아요.': { 'zh-TW': '尚未確認是否共用油炸設備 · 不計算交叉接觸機率。' },
  '달걀(튀김 반죽)': { 'zh-TW': '雞蛋（炸物麵糊）' },
  '튀김 반죽': { 'zh-TW': '炸物麵糊' },
  '달걀 사용 가능': { 'zh-TW': '可能使用雞蛋' },
  '엿기름으로 밥을 삭혀 은은하게 단맛을 낸 전통 쌀 음료예요.': { 'zh-TW': '以麥芽發酵米飯，帶出淡淡甜味的傳統米飲。' },
  '쌀·엿기름·설탕으로 만드는 식혜는 비건 기준에 맞는 음료예요. 실제 제품의 성분표는 확인해 주세요.': { 'zh-TW': '以米、麥芽與糖製成的韓式甜米釀符合全素需求；仍請查看實際產品成分標示。' },
  '일반적인 재료: 쌀, 엿기름, 설탕, 물.': { 'zh-TW': '常見食材：米、麥芽、糖、水。' },
  '실제 식혜의 성분표를 볼 수 있나요? 꿀 등 다른 첨가 재료가 있나요?': { 'zh-TW': '可以查看這款甜米釀的成分標示嗎？有蜂蜜或其他添加物嗎？' },
  '제조·소분 과정의 새우 교차접촉 정보는 확인되지 않았어요.': { 'zh-TW': '目前沒有製造與分裝過程中蝦類交叉接觸的資訊。' },
  '계피와 생강을 달여 달콤하게 식힌 향긋한 전통 음료예요.': { 'zh-TW': '以桂皮與生薑熬煮後加甜、冰鎮的芳香傳統飲品。' },
  '계피·생강·곶감·설탕으로 만드는 수정과는 비건 기준에 맞아요. 꿀을 사용하는지는 확인해 주세요.': { 'zh-TW': '以桂皮、生薑、柿餅與糖製成的飲品符合全素需求；請確認是否使用蜂蜜。' },
  '설탕 또는 꿀로 단맛을 내므로 감미료 확인이 필요해요.': { 'zh-TW': '可能使用糖或蜂蜜調味，需要確認甜味來源。' },
  '설탕 대신 꿀을 사용하나요? 실제 원재료를 확인할 수 있나요?': { 'zh-TW': '有用蜂蜜取代糖嗎？可以確認實際原料嗎？' },
  '곁들이는 고명과 제조·보관 환경은 별도 확인이 필요해요.': { 'zh-TW': '搭配配料以及製作、保存環境需要另外確認。' },
  '새우 알레르기': { 'zh-TW': '蝦類過敏' },
  '일반 조리법 참고 · 매장 미확인': { 'zh-TW': '一般做法參考 · 尚未經餐廳確認' },
  '성수에서 만난\n초록빛 한 끼': { 'zh-TW': '在聖水遇見的\n清新綠意餐桌' },
  '초록식탁 · 레시피를 투명하게 확인한 파트너': { 'zh-TW': '綠意餐桌 · 食譜資訊透明的合作餐廳' },
  '채소가 있는 한식': { 'zh-TW': '蔬食韓國料理' },
  '편안한 한 끼': { 'zh-TW': '暖心家常料理' },
  '계절의 한 그릇': { 'zh-TW': '當季風味餐點' },
  '고운한상': { 'zh-TW': '高韻韓桌' },
  '솔빛다이닝': { 'zh-TW': '松光餐廳' },
  '담소정': { 'zh-TW': '談笑亭' },
  '바다 곁 식탁': { 'zh-TW': '海畔餐桌' },
...
const interpolateDynamicText = (language: Language, ko: string): string | undefined => {
  ...
  if (count) {
    return ({ 'zh-CN': `识别出 ${count} 个菜品`, ja: `${count}件のメニューを認識`, 'zh-TW': `辨識出 ${count} 道餐點`, es: `${count} platos detectados` } as Record<NewLanguage, string>)[language];
  }

  const analyzedCount = ko.match(/^메뉴 (\d+)개 분석$/)?.[1];
  if (analyzedCount) {
    return ({ 'zh-CN': `已分析 ${analyzedCount} 个菜品`, ja: `${analyzedCount}件のメニューを分析`, 'zh-TW': `已分析 ${analyzedCount} 道餐點`, es: `${analyzedCount} platos analizados` } as Record<NewLanguage, string>)[language];
  }

  const checkedCount = ko.match(/^메뉴 (\d+)개를 확인했어요$/)?.[1];
  if (checkedCount) {
    return ({ 'zh-CN': `已检查 ${checkedCount} 个菜品`, ja: `${checkedCount}件のメニューを確認しました`, 'zh-TW': `已檢查 ${checkedCount} 道餐點`, es: `Se comprobaron ${checkedCount} platos` } as Record<NewLanguage, string>)[language];
  }
  ...
  const resultMenuCount = ko.match(/^메뉴 (\d+)개를 내 식단 기준으로 살펴봤어요\.$/)?.[1];
  if (resultMenuCount) {
    return ({ 'zh-CN': `已按照你的饮食需求查看 ${resultMenuCount} 个菜品。`, ja: `${resultMenuCount}件のメニューを食事条件に照らして確認しました。`, 'zh-TW': `已依照你的飲食需求查看 ${resultMenuCount} 道餐點。`, es: `Revisamos ${resultMenuCount} platos según tu perfil alimentario.` } as Record<NewLanguage, string>)[language];
  }

  const staffEvidence = ko.match(/^확인 (\d+)건 중 사용 (\d+)건$/);
  if (staffEvidence) {
    return ({ 'zh-CN': `${staffEvidence[1]} 条确认记录中采用 ${staffEvidence[2]} 条`, ja: `${staffEvidence[1]}件の確認中${staffEvidence[2]}件を使用`, 'zh-TW': `${staffEvidence[1]} 筆確認紀錄中採用 ${staffEvidence[2]} 筆`, es: `${staffEvidence[2]} de ${staffEvidence[1]} verificaciones utilizadas` } as Record<NewLanguage, string>)[language];
  }

  const feedback = ko.match(/^(\d+)명 중 (\d+)명이 요청을 전달하기 편했어요$/);
  if (feedback) {
    return ({ 'zh-CN': `${feedback[1]} 人中有 ${feedback[2]} 人表示需求容易沟通`, ja: `${feedback[1]}人中${feedback[2]}人が希望を伝えやすかったと回答`, 'zh-TW': `${feedback[1]} 人中有 ${feedback[2]} 人表示需求很好溝通`, es: `${feedback[2]} de ${feedback[1]} personas pudieron comunicar su solicitud fácilmente` } as Record<NewLanguage, string>)[language];
  }

  const menuObservation = ko.match(/^메뉴판: (.+) · ([\d,]+)원$/);
  if (menuObservation) {
    const localizedMenu = PROVISIONAL_TRANSLATIONS[menuObservation[1]]?.[language] ?? menuObservation[1];
    return ({
      'zh-CN': `菜单：${localizedMenu} · ₩${menuObservation[2]}`,
      ja: `メニュー：${localizedMenu} · ₩${menuObservation[2]}`,
      'zh-TW': `菜單：${localizedMenu} · ₩${menuObservation[2]}`,
      es: `Menú: ${localizedMenu} · ₩${menuObservation[2]}`,
    } as Record<NewLanguage, string>)[language];
  }
