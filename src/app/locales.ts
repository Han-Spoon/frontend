...
const PROVISIONAL_TRANSLATIONS: Record<string, ProvisionalTranslation> = {
  ...
  '식당 이름 검색': { 'zh-CN': '按餐厅名称搜索', ja: '店名で検索', 'zh-TW': '按餐廳名稱搜尋', es: 'Buscar por nombre' },
  '현재 위치 주변의 등록된 식당을 찾아 메뉴판과 연결해요.': { 'zh-CN': '查找当前位置附近已登记的餐厅并关联菜单。', ja: '現在地周辺の登録済み店舗を探してメニューと紐づけます。', 'zh-TW': '尋找目前位置附近已登記的餐廳並連結菜單。', es: 'Busca un restaurante registrado cerca de tu ubicación y vincúlalo al menú.' },
  '현재 위치를 확인하고 있어요.': { 'zh-CN': '正在获取当前位置。', ja: '現在地を確認しています。', 'zh-TW': '正在取得目前位置。', es: 'Buscando tu ubicación actual.' },
  '주변 식당을 찾으려면 위치 권한이 필요해요.': { 'zh-CN': '需要位置权限才能查找附近的餐厅。', ja: '周辺のお店を探すには位置情報の許可が必要です。', 'zh-TW': '需要位置權限才能尋找附近的餐廳。', es: 'Necesitamos acceso a tu ubicación para encontrar restaurantes cercanos.' },
  '위치 다시 확인': { 'zh-CN': '重新获取位置', ja: '位置情報を再確認', 'zh-TW': '重新取得位置', es: 'Reintentar ubicación' },
  '이름 검색 결과': { 'zh-CN': '名称搜索结果', ja: '店名の検索結果', 'zh-TW': '名稱搜尋結果', es: 'Resultados por nombre' },
  '현재 위치 주변': { 'zh-CN': '当前位置附近', ja: '現在地周辺', 'zh-TW': '目前位置附近', es: 'Cerca de tu ubicación' },
  '식당을 찾고 있어요.': { 'zh-CN': '正在查找餐厅。', ja: 'お店を探しています。', 'zh-TW': '正在尋找餐廳。', es: 'Buscando restaurantes.' },
  '식당 목록을 불러오지 못했어요. 잠시 후 다시 시도해 주세요.': { 'zh-CN': '无法加载餐厅列表，请稍后重试。', ja: 'お店の一覧を読み込めませんでした。しばらくしてからもう一度お試しください。', 'zh-TW': '無法載入餐廳清單，請稍後再試。', es: 'No se pudo cargar la lista. Inténtalo de nuevo en unos minutos.' },
  '검색된 식당이 없어요. 다른 이름으로 찾아보세요.': { 'zh-CN': '没有匹配的餐厅，请尝试其他名称。', ja: '該当するお店がありません。別の名前で検索してください。', 'zh-TW': '沒有符合的餐廳，請嘗試其他名稱。', es: 'No encontramos ese restaurante. Prueba con otro nombre.' },
  '주변에 등록된 식당이 아직 없어요.': { 'zh-CN': '附近还没有已登记的餐厅。', ja: '周辺にはまだ登録済みのお店がありません。', 'zh-TW': '附近還沒有已登記的餐廳。', es: 'Todavía no hay restaurantes registrados cerca.' },
  '주소 정보 없음': { 'zh-CN': '暂无地址', ja: '住所情報なし', 'zh-TW': '暫無地址', es: 'Dirección no disponible' },
  '검색된 식당이 없어요.': { 'zh-CN': '没有匹配的餐厅。', ja: '該当するお店がありません。', 'zh-TW': '沒有符合的餐廳。', es: 'No encontramos ese restaurante.' },
  '식당 없이 스캔하기': { 'zh-CN': '不选餐厅直接扫描', ja: 'お店を選ばずスキャン', 'zh-TW': '不選餐廳直接掃描', es: 'Escanear sin restaurante' },
  '내 주변 식당 찾기': { 'zh-CN': '查找附近的餐厅', ja: '近くのお店を探す', 'zh-TW': '尋找附近的餐廳', es: 'Encontrar restaurantes cercanos' },
  '현재 위치에서 가게 찾기': { 'zh-CN': '从当前位置查找', ja: '現在地からお店を探す', 'zh-TW': '從目前位置尋找', es: 'Buscar desde mi ubicación' },
  '등록된 실제 가게를 거리순으로 확인해요.': { 'zh-CN': '按距离查看已登记的真实餐厅。', ja: '登録済みの実店舗を距離順に確認できます。', 'zh-TW': '按距離查看已登記的實際餐廳。', es: 'Consulta restaurantes registrados ordenados por distancia.' },
  ...
  '낯선 메뉴도,\n맛있는 발견으로.': { 'zh-CN': '陌生的菜单，\n也能成为美味发现。', ja: '知らないメニューを、\nおいしい発見に。', 'zh-TW': '陌生的菜單，\n也能成為美味發現。', es: 'Convierte un menú desconocido\nen un delicioso descubrimiento.' },
  '메뉴판 한 장이면 번역부터 내 식단 확인, 식당에서 필요한 말까지 준비해드려요.': { 'zh-CN': '只需一张菜单照片，即可获得翻译、饮食提示和餐厅沟通用语。', ja: 'メニューを1枚撮るだけで、翻訳から食事条件の確認、お店で必要な言葉まで用意します。', 'zh-TW': '只需一張菜單照片，即可獲得翻譯、飲食提示和餐廳溝通用語。', es: 'Con una foto del menú obtienes traducción, orientación alimentaria y las frases que necesitas en el restaurante.' },
  '한스푼 주요 기능': { 'zh-CN': 'Han Spoon 核心功能', ja: 'Han Spoonの主な機能', 'zh-TW': 'Han Spoon 核心功能', es: 'Funciones principales de Han Spoon' },
  '메뉴 번역': { 'zh-CN': '菜单翻译', ja: 'メニュー翻訳', 'zh-TW': '菜單翻譯', es: 'Traducción' },
  '식단 확인': { 'zh-CN': '饮食确认', ja: '食事条件を確認', 'zh-TW': '飲食確認', es: 'Comprobar dieta' },
  '직원 소통': { 'zh-CN': '与店员沟通', ja: 'スタッフと会話', 'zh-TW': '與店員溝通', es: 'Hablar con el personal' },
  '한스푼 시작하기': { 'zh-CN': '开始使用 Han Spoon', ja: 'Han Spoonを始める', 'zh-TW': '開始使用 Han Spoon', es: 'Empezar con Han Spoon' },
  '계속하면 Google 계정으로 로그인할 수 있어요.': { 'zh-CN': '继续即可使用 Google 账号安全登录。', ja: '続けるとGoogleアカウントで安全にログインできます。', 'zh-TW': '繼續即可使用 Google 帳號安全登入。', es: 'Continúa para iniciar sesión de forma segura con Google.' },
  '한국의 맛을\n편안하게 만나보세요.': { 'zh-CN': '轻松探索\n韩国美食。', ja: '韓国の味を\n気軽に楽しもう。', 'zh-TW': '輕鬆探索\n韓國美食。', es: 'Descubre la comida coreana\ncon confianza.' },
  '별도 회원가입 없이 Google 계정 하나로 시작할 수 있어요.': { 'zh-CN': '无需另外注册，使用一个 Google 账号即可开始。', ja: '別の会員登録は不要。Googleアカウントひとつで始められます。', 'zh-TW': '無需另外註冊，使用一個 Google 帳號即可開始。', es: 'Empieza con una cuenta de Google, sin registro adicional.' },
  'Google로만 로그인해요': { 'zh-CN': '仅使用 Google 登录', ja: 'Googleログインのみ', 'zh-TW': '僅使用 Google 登入', es: 'Solo inicio de sesión con Google' },
  '이메일 비밀번호를 새로 만들 필요 없이 기존 Google 인증 흐름을 사용해요.': { 'zh-CN': '使用现有 Google 身份验证，无需创建新的邮箱密码。', ja: '新しいパスワードを作らず、既存のGoogle認証を利用します。', 'zh-TW': '使用現有 Google 身分驗證，無需建立新的電子郵件密碼。', es: 'Usa la autenticación de Google sin crear otra contraseña.' },
  '로그인 후 개인정보와 식단 정보는 내 프로필에서 관리할 수 있어요.': { 'zh-CN': '登录后可在个人资料中管理个人与饮食信息。', ja: 'ログイン後、個人情報と食事情報はプロフィールで管理できます。', 'zh-TW': '登入後可在個人資料中管理個人與飲食資訊。', es: 'Después de iniciar sesión, gestiona tu información personal y alimentaria desde tu perfil.' },
