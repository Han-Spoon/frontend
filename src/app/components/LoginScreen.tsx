    ...
    <div className="h-screen flex flex-col bg-white relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-center mb-2">{t('한 스푼', 'Han Spoon')}</h1>
        </div>

        <p className="text-lg text-neutral-600 text-center mb-12">
          {t('한국 메뉴판 더 쉽게 이해하기', 'Understand Korean menus more easily')}
        </p>
        ...
        <div className="space-y-4 mb-16 w-full max-w-xs">
          <div className="flex items-center gap-3 text-neutral-700">
            ...
            <span className="text-sm">{t('메뉴 번역', 'Menu translation')}</span>
          </div>
          <div className="flex items-center gap-3 text-neutral-700">
            <div className="w-8 h-8 rounded-full bg-neutral-100 flex items-center justify-center flex-shrink-0">
              <span className="text-sm">⚠️</span>
            </div>
            <span className="text-sm">{t('알레르기 경고', 'Allergy warnings')}</span>
          </div>
          <div className="flex items-center gap-3 text-neutral-700">
            <div className="w-8 h-8 rounded-full bg-neutral-100 flex items-center justify-center flex-shrink-0">
              <span className="text-sm">💬</span>
            </div>
            <span className="text-sm">{t('사장님 소통', 'Communicate with staff')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 pb-8">
        ...
        >
          ...
          <span className="font-medium">{t('Google로 로그인', 'Sign in with Google')}</span>
        </button>
        <p className="text-xs text-neutral-500 text-center px-4">
          {t('개인정보와 식단 정보가 안전하게 저장됩니다', 'Your personal and diet information is stored securely')}
        </p>
      </div>
    </div>
  );
